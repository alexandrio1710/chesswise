...
def api_insights(source: str | None = Query(default=None), profile_id: int | None = Depends(auth.require_profile_filter_access)):
    ...
    return {
        ...
        "acpl_by_time_control": insights.acpl_by_time_control(source, profile_id),
        "performance_rating_by_time_control": insights.performance_rating_by_time_control(source, profile_id),
